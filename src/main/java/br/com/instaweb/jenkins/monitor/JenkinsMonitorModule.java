...
import br.com.instaweb.jenkins.monitor.tasks.status.PullRequestsTask;
...
public class JenkinsMonitorModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(PullRequestsTask.class).in(SINGLETON);
       ...
       bind(JenkinsMonitor.class).in(SINGLETON);
        ...
        bind(Task.class).annotatedWith(Names.named("pullRequestPollerTask")).to(PullRequestsTask.class);
