...
public class PullRequestPoller implements Runnable {

	private final Task task;
	private Integer interval;

	@Inject
	public PullRequestPoller(@Named("pullRequestPollerTask") Task pollTask, @Named("taskInterval") Integer interval) {
		this.task = pollTask;
